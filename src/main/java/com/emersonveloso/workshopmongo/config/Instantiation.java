package com.emersonveloso.workshopmongo.config;
...
import com.emersonveloso.workshopmongo.dto.AuthorDTO;
import com.emersonveloso.workshopmongo.dto.CommentDTO;
import com.emersonveloso.workshopmongo.repository.PostRepository;
...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null,
                simpleDateFormat.parse("21/03/2018"), "Partiu viagem", "Vou viajar para São Paulo. Abraços!",
                new AuthorDTO(maria));
        Post post2 = new Post(null,
                simpleDateFormat.parse("23/03/2018"), "Bom dia", "Acordei feliz hoje!", new AuthorDTO(maria));
